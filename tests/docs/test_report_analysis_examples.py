...
class TestReportAnalysisExamples:
    ...
    @pytest.mark.asyncio
    async def test_get_report_rankings_example(self, api_client_config, test_report_code):
    ...
    @pytest.mark.asyncio
    async def test_get_report_player_details_example(self, api_client_config, test_report_code):
    ...
    async def test_error_handling_example(self, api_client_config):
        ...
        async with Client(**api_client_config) as client:
            ...
            with pytest.raises((GraphQLClientHttpError, GraphQLClientGraphQLMultiError, ValidationError)):
    ...
    @pytest.mark.asyncio
    async def test_comprehensive_analysis_pattern(self, api_client_config, test_report_code):
    ...
    async def test_data_structure_validation(self, api_client_config, test_report_code):
        ...
        async with Client(**api_client_config) as client:
            ...
            assert isinstance(player_details.report_data.report.player_details['data'], dict)
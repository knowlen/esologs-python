...
class TestAuthenticationDocumentationIntegrity:
    ...
    def test_environment_variable_handling(self):
        ...
        assert esologs_id is not None, "ESOLOGS_ID environment variable should be set for tests"
        assert esologs_secret is not None, "ESOLOGS_SECRET environment variable should be set for tests"
